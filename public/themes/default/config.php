...
return array(
    ...
    'title' => 'Pageweb Default Theme',
    'description' => 'A minimal twitter boostrap 3.0 single page theme.',
    /*
      |--------------------------------------------------------------------------
    ...
    'options' => array(
        ...
        'page_portfolio_title' => ['type' => 'text'],
        'footer_address' => ['type' => 'textarea'],
