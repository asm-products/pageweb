...
<div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="plan">
                            ...
                            <li class="plan-action">
                                <a href="{{URL::route('sites.subscription.checkout', ['site_id' => $siteId])}}?plan=pw_personal_monthly" class="btn btn-custom">Select</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="plan">
                            ...
                            <li class="plan-action">
                                <a href="{{URL::route('sites.subscription.checkout', ['site_id' => $siteId])}}?plan=pw_business_monthly" class="btn btn-custom">Select</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="plan">
                            ...
                            <li><strong>Custom</strong> Pages</li>
                            <li class="plan-action">
                                <a href="{{URL::route('sites.subscription.checkout', ['site_id' => $siteId])}}?plan=pw_professional_monthly" class="btn btn-custom">Select</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-pane" id="yearly">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="plan">
                            ...
                            <li><strong>Custom</strong> Domain</li>
                            <li class="plan-action">
                                <a href="{{URL::route('sites.subscription.checkout', ['site_id' => $siteId])}}?plan=pw_personal_yearly" class="btn btn-custom">Select</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="plan">
                            ...
                            <li><strong>Custom</strong> Pages</li>
                            <li class="plan-action">
                                <a href="{{URL::route('sites.subscription.checkout', ['site_id' => $siteId])}}?plan=pw_business_yearly" class="btn btn-custom">Select</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="plan">
                            ...
                            <li><strong>Custom</strong> Pages</li>
                            <li class="plan-action">
                                <a href="{{URL::route('sites.subscription.checkout', ['site_id' => $siteId])}}?plan=pw_professional_yearly" class="btn btn-custom">Select</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="text-center">FAQ on payment</h3>
